...
import {
  ...
  Info,
  ArrowLeft,
} from "lucide-react"; // ArrowLeft დავამატე
  ...
  return (
    <div className="p-4 lg:p-8 bg-[#fafafa] min-h-screen font-sans">
      <div className="max-w-6xl mx-auto">
        {/* 1. Header Section - აქ ჩაჯდა Back ღილაკი */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          {/* Telegram */}
          <div
            className={`p-5 rounded-[24px] border flex items-center gap-4 ${shop.telegram_chat_id ? "bg-blue-50 border-blue-100" : "bg-gray-50 border-gray-200"}`}
          >
            <div
        ...
        {/* 3. Main Content Section (იგივე რჩება) */}
