...
async function getBasicPrompt(shop, session, userText) {
  ...
  return `
    ...
    ### 🛠️ RULES
    1. **Strict Inventory:** If a brand, model, or size isn't in the [FULL INVENTORY], we don't have it, before rejecting ask the user to specify a product from our list.
    ...
    6. **Confirmation:** If user confirms an order, finalize "extracted" fields and ask for phone number and address. 
